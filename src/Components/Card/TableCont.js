...
const TableCont = () => {
  ...
  const fetchdata = () => {
    axios
      // .get(
      //   "https://rest.coinapi.io/v1/exchanges?apikey=5B23C53E-EC7B-4CF6-8A17-21D96D3A3139"
      // )
      .get(
     ...
     const update=data.map((row) => (
        <TableRow onClick={(event) => onclickhandler(event)} align="center" style={{height:'60px'}}>
          ...
          <TableCell align="center" >
              ...
              <button  className={istrue?clickafter.after :clickbefore.before}   width='40px' height='25px'>button </button>
